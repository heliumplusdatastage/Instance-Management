...
def run_instance(connection, target_image_id, block_device_map, security_group, username, ins_type, unit, ins_name):
    ...
    try:
        instance.add_tag("Instance Name", ins_name)
    ...
    return eip.public_ip, instance.id
...
def main(username, ins_type, ins_name):
    target_images = []
    block_device_maps = []
    ...
    instance_ip, instanceid = run_instance(connection, target_images[0], block_device_maps[0], source_sg, username, ins_type, unit, ins_name)
    ...
    instance_ip = str(instance_ip) + ":8000"

    return instance_ip, instanceid
